    ...
    public function syncTicket(int $companyId, TicketDespacho $ticket, User $actor): array
    {
        return DB::transaction(function () use ($companyId, $ticket, $actor): array {
            ...
            return [
                ...
                // Se conservan estas claves temporalmente para no romper consumidores
                // mientras las obligaciones de proveedor migran al modulo de compras.
                'purchase_document_ids' => [],
                'pending_purchase_costs' => 0,
            ];
        }, 3);
    }
