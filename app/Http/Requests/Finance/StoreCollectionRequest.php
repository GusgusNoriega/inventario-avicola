...
class StoreCollectionRequest extends FinancialFormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'cobrador_id' => ['required', 'integer', 'min:1'],
            'fecha_hora' => ['required', 'date'],
            'cuenta_destino_id' => ['required', 'integer', 'min:1'],
    ...
    protected function prepareForValidation(): void
    {
        ...
        $this->merge([
            ...
            'importe_total' => $this->normalizeAmount($this->input('importe_total')),
