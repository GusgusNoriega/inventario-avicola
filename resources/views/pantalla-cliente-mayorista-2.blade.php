@php
  ...
  $customerDisplayTitle = $customerDisplayTitle ?? 'Despacho mayorista 2 en vivo';
...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/pantalla-cliente-mayorista-2.css') }}?v={{ filemtime(public_path('css/pantalla-cliente-mayorista-2.css')) }}">
</head>
<body
...
>
  ...
  @else
    <script type="module" src="{{ asset('js/pantalla-cliente-mayorista-2.js') }}?v={{ filemtime(public_path('js/pantalla-cliente-mayorista-2.js')) }}"></script>
  @endif
</body>
</html>
