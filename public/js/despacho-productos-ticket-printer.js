...
function printableHtml(response, options = {}) {
  ...
  <style>
    ...
    *{box-sizing:border-box}
    body{width:74mm;margin:0;color:#111;font:8.5px/1.12 ui-monospace,"Cascadia Mono",Consolas,monospace}
    h1{margin:0;text-align:center;font-size:12px;line-height:1.05;white-space:pre-line;overflow-wrap:anywhere}
    .subtitle{text-align:center;font-size:9px;font-weight:800;margin:2px 0 6px}
    .control{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:1px 6px;align-items:baseline}
    .control strong{font-size:9.5px}.code{text-align:right;overflow-wrap:anywhere}
    .date-label{margin-top:2px}.time{text-align:right}
    .sale{text-align:center;font-weight:800;font-size:9.5px;margin:5px 0 2px;overflow-wrap:anywhere}
    table{width:100%;table-layout:fixed;border-collapse:collapse}
    th{padding:1.5px 1px;border-top:1px solid #111;border-bottom:1px solid #111;font-size:7.5px;white-space:nowrap}
    ...
    .price small{display:block;font-size:6px;font-weight:400}.empty{text-align:center;padding:6px 0}
    .total{display:flex;justify-content:flex-end;gap:10px;margin-top:5px;padding-top:3px;border-top:1px solid #111;font-size:11px;font-weight:900}
    .observ{min-height:16px;margin-top:10px;font-size:9px;font-weight:800;border-bottom:1px solid #111}
    .footer{margin:7px 0 0;text-align:center;font-size:8.5px;white-space:pre-line;overflow-wrap:anywhere}
