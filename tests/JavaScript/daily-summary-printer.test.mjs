...
test("la impresión muestra VARIOS en una fila consolidada", () => {
  const html = buildDailySummaryPrintHtml({
    dateLabel: "31 de julio de 2026",
    ...
    tableHtml: `
      <table>
        ...
        <tbody>
          <tr data-print-price="VARIOS" data-print-amount="670.04"><td>Cliente mixto</td><td>P V, P P</td></tr>
  ...
  assert.match(html, /Cliente mixto<\/td><td>P V, P P<\/td><td class="daily-client-price">VARIOS<\/td><td class="daily-client-amount">670\.04<\/td>/);
  assert.match(html, /<td class="daily-client-price">SIN PRECIO<\/td><td class="daily-client-amount">--<\/td>/);
  assert.equal((html.match(/class="daily-client-price"/g) || []).length, 2);
