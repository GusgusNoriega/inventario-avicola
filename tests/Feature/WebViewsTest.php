...
class WebViewsTest extends TestCase
{
    ...
    public function test_product_dispatch_menu_and_catalog_expose_the_new_workflow(): void
    {
        ...
        $dispatch
            ...
            ->assertSee('id="pddNumericKeypadHint"', false)
            ->assertSee('data-pdd-keypad-confirm-label="Mostrar este peso"', false)
            ->assertDontSee('id="pddManualDialog"', false)
            ->assertDontSee('id="pddManualForm"', false)
            ...
            ->assertSee('id="pddViewDialog"', false)
            ->assertSee('id="pddQuickProductForm"', false)
            ->assertSee('id="pddQuickProductSearch"', false)
            ->assertSee('id="pddQuickProductSelection"', false)
            ->assertSee('id="pddQuickProductResults"', false)
            ->assertSee('id="pddSaveQuickProducts"', false)
            ->assertSee('id="pddWastePresetForm"', false)
            ->assertSee('id="pddZoomOut"', false)
